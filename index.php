        ...
        <div class="w-full md:w-1/2 flex items-center justify-center px-margin-mobile md:px-margin-desktop py-stack-lg">
            <div
                ...
                <div class="text-center mb-stack-lg">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant">Manage your income, expenses, budgets,
                        and savings with confidence.</p>
                </div>
                <form class="space-y-stack-md" id="registrationForm">
                    <!-- Full Name -->
                    <div class="relative fade-in-up stagger-1">
                        ...
                        <input
                            class="w-full h-[56px] pl-[48px] pr-4 rounded-[24px] border border-outline-variant/50 bg-surface focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all font-body-md text-body-md outline-none"
                    ...
                    <div class="relative fade-in-up stagger-2">
                        ...
                        <input
                            class="w-full h-[56px] pl-[48px] pr-[48px] rounded-[24px] border border-outline-variant/50 bg-surface focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all font-body-md text-body-md outline-none"
                    ...
                    <!-- Preferred Currency & Monthly Budget -->
                    <div class="flex gap-stack-md fade-in-up stagger-3">
                        <div class="relative w-1/3">
                            <select
                                class="w-full h-[56px] pl-4 pr-8 rounded-[24px] border border-outline-variant/50 bg-surface focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all font-body-md text-body-md outline-none appearance-none">
                        ...
                        <div class="relative w-2/3">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-secondary font-body-md">₹</span>
                            <input
                                class="w-full h-[56px] pl-[32px] pr-4 rounded-[24px] border border-outline-variant/50 bg-surface focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all font-body-md text-body-md outline-none"
                                placeholder="Monthly Budget (Optional)" type="number" />
                        </div>
                    </div>
                    <!-- Terms -->
